"use strict";
var FileContentsExtended = (function () {
    function FileContentsExtended() {
    }
    FileContentsExtended.prototype.camelCase = function (input) {
        return input.replace(/-([a-z])/gi, function (all, letter) {
            return letter.toUpperCase();
        });
    };
    FileContentsExtended.prototype.componentContent = function (inputName) {
        var inputUpperCase;
    ...
    FileContentsExtended.prototype.serviceContent = function (inputName) {
        var inputUpperCase;
        inputUpperCase = inputName.charAt(0).toUpperCase() + inputName.slice(1);
        inputUpperCase = this.camelCase(inputUpperCase);
    ...
    FileContentsExtended.prototype.modelContent = function (inputName) {
        var inputUpperCase;
        inputUpperCase = inputName.charAt(0).toUpperCase() + inputName.slice(1);
        inputUpperCase = this.camelCase(inputUpperCase);
        var modelContent = 'export class ' +
            inputUpperCase +
            ' {\n' +
            '\tid: number;\n' +
            '\tname: string;\n' +
    ...
    FileContentsExtended.prototype.templateContent = function (inputName) {
        var inputUpperCase;
        inputUpperCase = inputName.charAt(0).toUpperCase() + inputName.slice(1);
        inputUpperCase = this.camelCase(inputUpperCase);
    ...
    FileContentsExtended.prototype.cssContent = function (inputName) {
        var inputUpperCase = inputName.charAt(0).toUpperCase() + inputName.slice(1);
        var cssContent = "." + inputName + " {\n\n}";
        return cssContent;
    };
    FileContentsExtended.prototype.specContent = function (inputName) {
        var inputUpperCase;
        inputUpperCase = inputName.charAt(0).toUpperCase() + inputName.slice(1);
        inputUpperCase = this.camelCase(inputUpperCase);
